...
Durante el desarrollo del sistema se aplicó principalmente una organización basada en componentes, ya que la aplicación fue creada con React. Esto permite dividir la interfaz en partes más pequeñas y reutilizables, como formularios, tarjetas de productos, navegación y pantallas principales.
